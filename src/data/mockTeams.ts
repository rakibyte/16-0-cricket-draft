...
export const ALL_TIME_TEAMS: Team[] = [
  {
    id: 'csk-all-time',
    leagueMode: 'ALL_TIME_XI',
    name: 'All-Time Chennai Super Kings',
    year: 2025,
    shortCode: 'CSK-AT',
    era: 'All-Time Franchise XI (2008-2025)',
    primaryColor: '#eab308',
    secondaryColor: '#1e3a8a',
    badgeSymbol: '👑🦁',
    overallRating: 96,
    roster: [
      { id: 'at_csk1', name: 'MS Dhoni', primaryRole: 'WICKETKEEPER', secondaryRole: 'MIDDLE_ORDER', battingRating: 96, bowlingRating: 30, fieldingRating: 98, overallRating: 97, stars: 5, isLegend: true, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk2', name: 'Suresh Raina', primaryRole: 'MIDDLE_ORDER', secondaryRole: 'SPIN_ALLROUNDER', battingRating: 94, bowlingRating: 72, fieldingRating: 95, overallRating: 93, stars: 5, isLegend: true, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk3', name: 'Ravindra Jadeja', primaryRole: 'SPIN_ALLROUNDER', secondaryRole: 'MIDDLE_ORDER', battingRating: 90, bowlingRating: 94, fieldingRating: 99, overallRating: 95, stars: 5, isLegend: true, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk4', name: 'Michael Hussey', primaryRole: 'OPENER', secondaryRole: 'MIDDLE_ORDER', battingRating: 92, bowlingRating: 40, fieldingRating: 85, overallRating: 90, stars: 5, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk5', name: 'Dwayne Bravo', primaryRole: 'PACE_ALLROUNDER', battingRating: 85, bowlingRating: 93, fieldingRating: 92, overallRating: 90, stars: 5, isLegend: true, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk6', name: 'Ravichandran Ashwin', primaryRole: 'FRONTLINE_SPINNER', secondaryRole: 'SPIN_ALLROUNDER', battingRating: 72, bowlingRating: 94, fieldingRating: 76, overallRating: 92, stars: 5, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk7', name: 'Muttiah Muralitharan', primaryRole: 'FRONTLINE_SPINNER', battingRating: 40, bowlingRating: 99, fieldingRating: 75, overallRating: 97, stars: 5, isLegend: true, countryOrFranchise: 'CSK All-Time' },
      { id: 'at_csk8', name: 'Ruturaj Gaikwad', primaryRole: 'OPENER', battingRating: 91, bowlingRating: 25, fieldingRating: 84, overallRating: 88, stars: 4, countryOrFranchise: 'CSK All-Time' },
    ]
  },
  {
    id: 'mi-all-time',
    leagueMode: 'ALL_TIME_XI',
    name: 'All-Time Mumbai Indians',
    year: 2025,
    shortCode: 'MI-AT',
    era: 'All-Time Franchise XI (2008-2025)',
    primaryColor: '#0284c7',
    ...
    overallRating: 97,
    roster: [
      { id: 'at_mi1', name: 'Lasith Malinga', primaryRole: 'FAST_BOWLER', battingRating: 40, bowlingRating: 99, fieldingRating: 78, overallRating: 98, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi2', name: 'Jasprit Bumrah', primaryRole: 'FAST_BOWLER', battingRating: 40, bowlingRating: 99, fieldingRating: 82, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi3', name: 'Rohit Sharma', primaryRole: 'OPENER', secondaryRole: 'MIDDLE_ORDER', battingRating: 96, bowlingRating: 45, fieldingRating: 86, overallRating: 96, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi4', name: 'Sachin Tendulkar', primaryRole: 'OPENER', battingRating: 95, bowlingRating: 50, fieldingRating: 82, overallRating: 94, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi5', name: 'Kieron Pollard', primaryRole: 'PACE_ALLROUNDER', secondaryRole: 'MIDDLE_ORDER', battingRating: 95, bowlingRating: 85, fieldingRating: 94, overallRating: 94, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi6', name: 'Suryakumar Yadav', primaryRole: 'MIDDLE_ORDER', battingRating: 97, bowlingRating: 30, fieldingRating: 92, overallRating: 96, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi7', name: 'Hardik Pandya', primaryRole: 'PACE_ALLROUNDER', battingRating: 92, bowlingRating: 88, fieldingRating: 90, overallRating: 92, stars: 5, isLegend: true, countryOrFranchise: 'MI All-Time' },
      { id: 'at_mi8', name: 'Harbhajan Singh', primaryRole: 'FRONTLINE_SPINNER', battingRating: 65, bowlingRating: 91, fieldingRating: 78, overallRating: 88, stars: 4, countryOrFranchise: 'MI All-Time' },
    ]
  },
  {
    id: 'ind-all-time',
    leagueMode: 'ALL_TIME_XI',
    name: 'All-Time Team India',
    year: 2025,
    shortCode: 'IND-AT',
    era: 'All-Time National Legends (1975-2025)',
    primaryColor: '#2563eb',
    secondaryColor: '#f97316',
    badgeSymbol: '🇮🇳👑',
    overallRating: 98,
    roster: [
      { id: 'at_ind1', name: 'Sachin Tendulkar', primaryRole: 'OPENER', secondaryRole: 'MIDDLE_ORDER', battingRating: 99, bowlingRating: 70, fieldingRating: 86, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind2', name: 'Virat Kohli', primaryRole: 'MIDDLE_ORDER', secondaryRole: 'OPENER', battingRating: 99, bowlingRating: 40, fieldingRating: 95, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind3', name: 'MS Dhoni', primaryRole: 'WICKETKEEPER', secondaryRole: 'MIDDLE_ORDER', battingRating: 96, bowlingRating: 30, fieldingRating: 98, overallRating: 97, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind4', name: 'Kapil Dev', primaryRole: 'PACE_ALLROUNDER', secondaryRole: 'MIDDLE_ORDER', battingRating: 94, bowlingRating: 97, fieldingRating: 92, overallRating: 97, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind5', name: 'Jasprit Bumrah', primaryRole: 'FAST_BOWLER', battingRating: 40, bowlingRating: 99, fieldingRating: 82, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind6', name: 'Yuvraj Singh', primaryRole: 'MIDDLE_ORDER', secondaryRole: 'SPIN_ALLROUNDER', battingRating: 97, bowlingRating: 88, fieldingRating: 95, overallRating: 96, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind7', name: 'Virender Sehwag', primaryRole: 'OPENER', secondaryRole: 'SPIN_ALLROUNDER', battingRating: 96, bowlingRating: 65, fieldingRating: 78, overallRating: 95, stars: 5, isLegend: true, countryOrFranchise: 'India All-Time' },
      { id: 'at_ind8', name: 'Zaheer Khan', primaryRole: 'FAST_BOWLER', battingRating: 35, bowlingRating: 95, fieldingRating: 76, overallRating: 93, stars: 5, countryOrFranchise: 'India All-Time' },
    ]
  },
  {
    id: 'aus-all-time',
    leagueMode: 'ALL_TIME_XI',
    name: 'All-Time Australia',
    year: 2025,
    shortCode: 'AUS-AT',
    era: 'All-Time Aussie Invincibles (1975-2025)',
    primaryColor: '#facc15',
    secondaryColor: '#15803d',
    badgeSymbol: '🦘👑',
    overallRating: 98,
    roster: [
      { id: 'at_aus1', name: 'Shane Warne', primaryRole: 'FRONTLINE_SPINNER', battingRating: 65, bowlingRating: 99, fieldingRating: 85, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus2', name: 'Glenn McGrath', primaryRole: 'FAST_BOWLER', battingRating: 30, bowlingRating: 99, fieldingRating: 78, overallRating: 98, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus3', name: 'Adam Gilchrist', primaryRole: 'WICKETKEEPER', secondaryRole: 'OPENER', battingRating: 96, bowlingRating: 30, fieldingRating: 97, overallRating: 97, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus4', name: 'Ricky Ponting', primaryRole: 'MIDDLE_ORDER', battingRating: 98, bowlingRating: 40, fieldingRating: 96, overallRating: 98, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus5', name: 'Matthew Hayden', primaryRole: 'OPENER', battingRating: 95, bowlingRating: 30, fieldingRating: 82, overallRating: 94, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus6', name: 'Steve Waugh', primaryRole: 'MIDDLE_ORDER', secondaryRole: 'PACE_ALLROUNDER', battingRating: 93, bowlingRating: 76, fieldingRating: 88, overallRating: 93, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus7', name: 'Brett Lee', primaryRole: 'FAST_BOWLER', battingRating: 52, bowlingRating: 96, fieldingRating: 80, overallRating: 94, stars: 5, isLegend: true, countryOrFranchise: 'Australia All-Time' },
      { id: 'at_aus8', name: 'Shane Watson', primaryRole: 'PACE_ALLROUNDER', battingRating: 92, bowlingRating: 88, fieldingRating: 85, overallRating: 92, stars: 5, countryOrFranchise: 'Australia All-Time' },
    ]
  },
  {
    id: 'wi-all-time',
    leagueMode: 'ALL_TIME_XI',
    name: 'All-Time West Indies',
    year: 2025,
    shortCode: 'WI-AT',
    era: 'All-Time Calypso Legends',
    primaryColor: '#881337',
    secondaryColor: '#eab308',
    badgeSymbol: '🌴👑',
    overallRating: 97,
    roster: [
      { id: 'at_wi1', name: 'Viv Richards', primaryRole: 'MIDDLE_ORDER', secondaryRole: 'SPIN_ALLROUNDER', battingRating: 99, bowlingRating: 75, fieldingRating: 94, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
      { id: 'at_wi2', name: 'Joel Garner', primaryRole: 'FAST_BOWLER', battingRating: 45, bowlingRating: 99, fieldingRating: 80, overallRating: 98, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
      { id: 'at_wi3', name: 'Michael Holding', primaryRole: 'FAST_BOWLER', battingRating: 40, bowlingRating: 98, fieldingRating: 82, overallRating: 97, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
      { id: 'at_wi4', name: 'Chris Gayle', primaryRole: 'OPENER', battingRating: 96, bowlingRating: 60, fieldingRating: 75, overallRating: 94, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
      { id: 'at_wi5', name: 'Andre Russell', primaryRole: 'PACE_ALLROUNDER', battingRating: 93, bowlingRating: 88, fieldingRating: 88, overallRating: 93, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
      { id: 'at_wi6', name: 'Sunil Narine', primaryRole: 'FRONTLINE_SPINNER', secondaryRole: 'OPENER', battingRating: 80, bowlingRating: 97, fieldingRating: 80, overallRating: 95, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
      { id: 'at_wi7', name: 'Clive Lloyd', primaryRole: 'MIDDLE_ORDER', battingRating: 92, bowlingRating: 40, fieldingRating: 86, overallRating: 91, stars: 5, isLegend: true, countryOrFranchise: 'West Indies All-Time' },
    ]
  },
  {
    id: 'rcb-all-time',
    leagueMode: 'ALL_TIME_XI',
    name: 'All-Time RCB Stars',
    year: 2025,
    shortCode: 'RCB-AT',
    era: 'All-Time Franchise XI (2008-2025)',
    primaryColor: '#dc2626',
    ...
    overallRating: 96,
    roster: [
      { id: 'at_rcb1', name: 'Virat Kohli', primaryRole: 'OPENER', secondaryRole: 'MIDDLE_ORDER', battingRating: 99, bowlingRating: 45, fieldingRating: 94, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'RCB All-Time' },
      { id: 'at_rcb2', name: 'AB de Villiers', primaryRole: 'MIDDLE_ORDER', secondaryRole: 'WICKETKEEPER', battingRating: 99, bowlingRating: 35, fieldingRating: 98, overallRating: 99, stars: 5, isLegend: true, countryOrFranchise: 'RCB All-Time' },
      { id: 'at_rcb3', name: 'Chris Gayle', primaryRole: 'OPENER', battingRating: 96, bowlingRating: 60, fieldingRating: 72, overallRating: 94, stars: 5, isLegend: true, countryOrFranchise: 'RCB All-Time' },
      { id: 'at_rcb4', name: 'Yuzvendra Chahal', primaryRole: 'FRONTLINE_SPINNER', battingRating: 30, bowlingRating: 94, fieldingRating: 70, overallRating: 90, stars: 5, countryOrFranchise: 'RCB All-Time' },
      { id: 'at_rcb5', name: 'Jacques Kallis', primaryRole: 'PACE_ALLROUNDER', battingRating: 90, bowlingRating: 88, fieldingRating: 86, overallRating: 90, stars: 4, isLegend: true, countryOrFranchise: 'RCB All-Time' },
      { id: 'at_rcb6', name: 'Zaheer Khan', primaryRole: 'FAST_BOWLER', battingRating: 35, bowlingRating: 93, fieldingRating: 76, overallRating: 90, stars: 4, isLegend: true, countryOrFranchise: 'RCB All-Time' },
    ]
  }
];
